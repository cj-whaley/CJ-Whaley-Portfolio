...
public class TileWorld {
    ...
    public void raise(int x, int y) {
        if(this.select(x, y) != null) {
        	tiles.addLast(this.select(x, y));
        	tiles.remove(this.select(x, y));
        }
    ...
    public void deleteAll(int x, int y) {
    	...
    	// go through toRemove and remove each of the tiles from this.tiles
    	...
    	//   repeat as long as __X__ (there are tiles under (x,y))
